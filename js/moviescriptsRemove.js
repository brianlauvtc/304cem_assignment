...
{	getdisplaynum();
	var mydata={"title":title};
		$.ajax({
		   ...
		   type: "POST", 
		   url: "http://127.0.0.1:9999/getfavcommentdetail",
...
$( document ).ready(function() {
	getdisplaynum();
	 var mydata={"type":"getfavonemoviedetail"};
	$.ajax({
		   
		   type: "POST", 
		   url: "http://127.0.0.1:9999/getfavonemoviedetail",
		   dataType:'JSON', // Data type, HTML, json etc.
            data:JSON.stringify(mydata), //Form variables
		   success:function(response)
		   {
...
$( document ).ready(function() {
	...
	update_database("Movieactors");
	 var mydata={"type":"getfavactordetail"};
		$.ajax({
		   
		   type: "POST", 
		   url: "http://127.0.0.1:9999/getfavactordetail",
		  dataType:'JSON', // Data type, HTML, json etc.
            data:JSON.stringify(mydata), //Form variables
		   success:function(response)
		   {	
...
$( document ).ready(function() {
	   ...
	   $('body').on('click', "#remove_favourite",function(){
		   ...
		   type: "POST", 
		   url: "http://127.0.0.1:9999/removefav",
		    dataType:'JSON', // Data type, HTML, json etc.
            data:JSON.stringify(mydata), //Form variables
		   success:function(response)
		   {
		   ...
		   if(result=="success")
		   {
				alert("Remove at favourite List successfully");
				window.location="/fav"
		   }
			 if(result=="fail")
		   {
				alert("Remove at favourite List was fail");

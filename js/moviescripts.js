...
$( document ).ready(function() {
	getdisplaynum();
		 var mydata={"type":"getonemoviedetail"};
	$.ajax({
		   
		   type: "POST", 
		   url: "http://127.0.0.1:9999/getonemoviedetail",
...
$( document ).ready(function() {
	...
	update_database("Movieactors");
	 var mydata={"type":"getactordetail"};
		$.ajax({
		   
		   type: "POST", 
		   url: "http://127.0.0.1:9999/getactordetail",
		   dataType:'JSON', // Data type, HTML, json etc.
            data:JSON.stringify(mydata), //Form variables
		   success:function(response)
		   {	
...
{	getdisplaynum();
	var mydata={"title":title};
		...
		$.ajax({
		   ...
		   type: "POST", 
		   url: "http://127.0.0.1:9999/getcommentdetail",
		   dataType:'JSON', // Data type, HTML, json etc.
            data:JSON.stringify(mydata), //Form variables
		   success:function(response)
		   {	
...
$( document ).ready(function() {
	   ...
	   $('body').on('click', "#Add_favourite",function(){
